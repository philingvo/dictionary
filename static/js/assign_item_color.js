function createPallet() {
	...
	colors.forEach(function(eachColor){
		...
		// palletElement.style["border-color"] = eachColor;
	...
	// var closePalletButton = document.createElement('div');
	// closePalletButton.id = 'close_pallet';
	// closePalletButton.classList('pallet_element');
	// closePalletButton.onclick = closePallet;
	// palletContainer.appendChild(closePalletButton);
